...
enum {
    ...
    //temp fix for private_internal_only
    GRALLOC_USAGE_PRIVATE_INTERNAL_ONLY	  =	  0x06000000,

//temp fix for private_secure_only
GRALLOC_USAGE_PRIVATE_SECURE_DISPLAY	= 0x6000000,
